...
var clientKoreanController = {
    ...
    fetchDetail: function (req, res, next) {
        ...
        Promise.all([KoreanModel.fetchById(req.params.id), KoreanModel.fetchRandom(condition), KoreanModel.fetchMostView()])
            .then(function (result) {
                return res.render('client/asian/korean/detail.html', {post: result[0], correlatives: result[1], mostViews: result[2]});
            });
